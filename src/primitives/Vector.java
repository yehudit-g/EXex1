...
public class Vector {
    ...
    //package friendly to be use directly by Point3D
     Point3D _head;
    ...
    public Vector subtract(Vector v) {
        return  new Vector(
                _head.x.coord - v._head.x.coord,
                _head.y.coord - v._head.y.coord,
                _head.z.coord - v._head.z.coord);
    }
    ...
    public Vector scale(double scalar) {
        return new Vector(
                _head.x.coord * scalar,
                _head.y.coord * scalar,
                _head.z.coord * scalar);
    }
    ...
    public Vector normalized() {
        double len = length();
       return  new Vector(_head.x.coord/len, _head.y.coord/len, _head.z.coord/len);
    }
