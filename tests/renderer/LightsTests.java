...
public class LightsTests {
    ...
    public void triangleManyLights() {
        ...
        scene2.lights.add(new SpotLight(new Color(500, 250, 250), new Point3D(10, -10, -130), new Vector(-2, -2, -1)) //
                .setKl(0.0001).setKq(0.000005));
        scene2.lights.add(new PointLight(new Color(500, 250, 250), new Point3D(75, 0, -130)) //
                .setKl(0.0005).setKq(0.0005));
        scene2.lights.add(new DirectionalLight(new Color(115, 67, 150), new Vector(0, 0, -1)));

        ImageWriter imageWriter = new ImageWriter("triangleManyLights", 500, 500);
        Render render = new Render()//
                .setImageWriter(imageWriter) //
                .setCamera(camera2) //
                .setRayTracer(new BasicRayTracer(scene2));
